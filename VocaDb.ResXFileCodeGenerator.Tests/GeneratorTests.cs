...
{{
	...
	[Fact]
	public void Generate_SyntaxFactory_Public()
	{
		Generate(generator: new SyntaxFactoryGenerator(), publicClass: true);
	}

	[Fact]
	public void Generate_SyntaxFactory_Internal()
	{
		Generate(generator: new SyntaxFactoryGenerator(), publicClass: false);
	}

	[Fact]
	public void Generate_StringBuilder_Public()
	{
		Generate(generator: new StringBuilderGenerator(), publicClass: true);
	}

	[Fact]
	public void Generate_StringBuilder_Internal()
	{
		Generate(generator: new StringBuilderGenerator(), publicClass: false);
	}
}
