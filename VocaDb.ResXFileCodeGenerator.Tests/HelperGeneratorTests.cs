...
public class HelperGeneratorTests
{
	...
	public void CanGenerateCombo()
	{
		var (generatedFileName, sourceCode, errorsAndWarnings) = new StringBuilderGenerator()
			.Generate(new CultureInfoCombo(new AdditionalTextWithHash[]
			{
				new(new AdditionalTextStub("test.da.rex"), Guid.NewGuid()),
				new(new AdditionalTextStub("test.da-dk.rex"), Guid.NewGuid())
			}), default);
		var expected = @"// ------------------------------------------------------------------------------
// <auto-generated>
