...
<root>
  ...
  <data name=""CreateDateDescending"" xml:space=""preserve"">
	...
	private static void Generate(IGenerator generator, bool publicClass = true, bool staticClass = true,
...
{{
    ...
    /// </summary>
    public{(staticMembers ? " static" : "")} string{(nullForgivingOperators ? "" : "?")} CreateDate => GetString_1030_6(""Oldest"", ""OldestDaDK"", ""OldestDa"");

    /// <summary>
    /// Looks up a localized string similar to Newest.
    /// </summary>
    public{(staticMembers ? " static" : "")} string{(nullForgivingOperators ? "" : "?")} CreateDateDescending => GetString_1030_6(""Newest"", ""NewestDaDK"", ""NewestDa"");
}}
";
